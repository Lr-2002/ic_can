...
void M_mtrx_fcn_atexit(void)
{
  ...
  M_mtrx_fcn_xil_terminate();
  M_mtrx_fcn_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_M_mtrx_fcn_api.c
 *
 * [EOF]
 */
