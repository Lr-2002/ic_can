 ...
 * File: _coder_regressorWithMotorDynamics_api.c
 *
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "regressorWithMotorDynamics",                         /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
static const mxArray *emlrt_marshallOut(const real_T u[396]);
...
/*
 * Arguments    : const real_T u[396]
 * Return Type  : const mxArray *
 */
static const mxArray *emlrt_marshallOut(const real_T u[396])
{
  static const int32_T iv[2] = {0, 0};
  static const int32_T iv1[2] = {6, 66};
  const mxArray *m;
  const mxArray *y;
  y = NULL;
                                    ...
                                    const mxArray **plhs)
{
  ...
  Y = (real_T(*)[396])mxMalloc(sizeof(real_T[396]));
  /* Marshall function inputs */
  q = emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "q");
  qd = emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "qd");
  q2d = emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "q2d");
  /* Invoke the target function */
  regressorWithMotorDynamics(*q, *qd, *q2d, *Y);
...
void regressorWithMotorDynamics_atexit(void)
{
  ...
  regressorWithMotorDynamics_xil_terminate();
  regressorWithMotorDynamics_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_regressorWithMotorDynamics_api.c
 *
 * [EOF]
 */
