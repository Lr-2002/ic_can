...
foreach(_expectedTarget IC_CAN::ic_can_core)
...
# Create imported target IC_CAN::ic_can_core
add_library(IC_CAN::ic_can_core SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/IC_CANCoreTargets-*.cmake")
