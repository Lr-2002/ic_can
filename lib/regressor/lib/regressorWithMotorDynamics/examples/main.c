...
You can call entry-point functions multiple times. */
  main_regressorWithMotorDynamics();
 ...
 * Return Type  : void
 */
void main_regressorWithMotorDynamics(void)
{
  double Y[396];
  double q_tmp[6];
  /* Initialize function 'regressorWithMotorDynamics' input arguments. */
  ...
  /* Call the entry-point 'regressorWithMotorDynamics'. */
  regressorWithMotorDynamics(q_tmp, q_tmp, q_tmp, Y);
}
