...
static void argInit_66x1_real_T(double result[66]);
 ...
 * Return Type  : void
 */
void main_M_mtrx_fcn(void)
{
  double dv1[66];
  double M_mtrx_sym[36];
  double dv[6];
  /* Initialize function 'M_mtrx_fcn' input arguments. */
  /* Initialize function input argument 'in1'. */
  /* Initialize function input argument 'in2'. */
  /* Call the entry-point 'M_mtrx_fcn'. */
  argInit_6x1_real_T(dv);
  argInit_66x1_real_T(dv1);
  M_mtrx_fcn(dv, dv1, M_mtrx_sym);
}
