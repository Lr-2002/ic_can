...
//
// _coder_G_vctr_fcn_api.cpp
//
// Code generation for function '_coder_G_vctr_fcn_api'
//
...
void G_vctr_fcn_api(const mxArray *const prhs[2], const mxArray **plhs)
{
  ...
  G_vctr_fcn(&st, *in1, *in2, *G_vctr_sym);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(*G_vctr_sym);
}

// End of code generation (_coder_G_vctr_fcn_api.cpp)
